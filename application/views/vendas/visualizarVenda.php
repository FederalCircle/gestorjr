                    ...
                    <div class="invoice-head">
                        <table class="table">
                            <tbody>
                                ...
                                <tr>
                                    <td colspan="3" class="alert">Você precisa configurar os dados do emitente. >>><a href="<?php echo base_url(); ?>index.php/gestorjr/emitente">Configurar</a><<<</td>
                                </tr>
                                <?php } else {?>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function Popup(data)
        {
            var mywindow = window.open('', 'gestorjr', 'height=600,width=800');
            mywindow.document.write('<html><head><title>Gestor Jr</title>');
