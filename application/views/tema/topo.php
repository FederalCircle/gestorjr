...
<div id="user-nav" class="navbar navbar-inverse">
  <ul class="nav">
    ...
    <li class=""><a title="" href="<?php echo base_url();?>index.php/gestorjr/minhaConta"><i class="icon icon-star"></i> <span class="text">Minha Conta</span></a></li>
    <li class=""><a title="" href="<?php echo base_url();?>index.php/gestorjr/sair"><i class="icon icon-share-alt"></i> <span class="text">Sair do Sistema</span></a></li>
     <li class=""><a title="" href="http://localhost/intranet/" target="_blank"><i class="icon icon-share-alt"></i> <span class="text">Site Intranet</span></a></li>
    <!--li class=""><a><font color="#eea400" size="2px">Associado: <?php echo $usuario->nome?></font></a></li-->
  </ul>
</div>

<!--start-top-serch-->
<div id="search">
  <form action="<?php echo base_url()?>index.php/gestorjr/pesquisar">
...
<div id="sidebar"> <a href="#" class="visible-phone"><i class="icon icon-list"></i> Menu</a>
  <ul>
    ...
    <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'vServico')){ ?>
        <li class="<?php if(isset($menuProjetos)){echo 'active';};?>"><a href="<?php echo base_url()?>index.php/projetos"><i class="icon icon-wrench"></i> <span>Projetos</span></a></li>
    <?php } ?>
        ...
        <li class="submenu <?php if(isset($menuConfiguracoes)){echo 'active open';};?>">
          ...
          <ul>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cEmitente')){ ?>
                <li><a href="<?php echo base_url()?>index.php/gestorjr/emitente">Emitente</a></li>
            <?php } ?>
            ...
            <?php if($this->permission->checkPermission($this->session->userdata('permissao'),'cBackup')){ ?>
                <li><a href="<?php echo base_url()?>index.php/gestorjr/backup">Backup</a></li>
            <?php } ?>
...
<!--Footer-part-->
<div class="row-fluid">
 <font color="#eea400"><div id="footer" class="span12"> <?php echo date('Y'); ?> &copy; Tecnologia da Informação - Poli Júnior Engenharia</div></font>
</div>
<!--end-Footer-part-->
