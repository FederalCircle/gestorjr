...
class gestorjr extends CI_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('gestorjr_model','',TRUE);
    ...
    public function index() {
        ...
        $this->data['ordens'] = $this->gestorjr_model->getOsAbertas();
        $this->data['produtos'] = $this->gestorjr_model->getProdutosMinimo();
        $this->data['os'] = $this->gestorjr_model->getOsEstatisticas();
        $this->data['estatisticas_financeiro'] = $this->gestorjr_model->getEstatisticasFinanceiro();
        $this->data['menuPainel'] = 'Painel';
        $this->data['view'] = 'gestorjr/painel';
    ...
    public function minhaConta() {
        ...
        $this->data['usuario'] = $this->gestorjr_model->getById($this->session->userdata('id'));
        $this->data['view'] = 'gestorjr/minhaConta';
        $this->load->view('tema/topo',  $this->data);
    ...
    public function alterarSenha() {
        ...
        $result = $this->gestorjr_model->alterarSenha($senha,$oldSenha,$this->session->userdata('id'));
        if($result){
            $this->session->set_flashdata('success','Senha Alterada com sucesso!');
            redirect(base_url() . 'index.php/gestorjr/minhaConta');
        }
        else{
    ...
    public function pesquisar() {
        ...
        $this->data['view'] = 'gestorjr/pesquisa';
        $this->load->view('tema/topo',  $this->data);
    ...
    public function emitente(){   
        ...
        $data['dados'] = $this->gestorjr_model->getEmitente();
        $data['view'] = 'gestorjr/emitente';
    ...
    public function cadastrarEmitente() {
        ...
        if((!$this->session->userdata('session_id')) || (!$this->session->userdata('logado'))){
            redirect('index.php/gestorjr/login');
        }
        ...
        if ($this->form_validation->run() == false) {
            ...
            redirect(base_url().'index.php/gestorjr/emitente');
            ...
            $retorno = $this->gestorjr_model->addEmitente($nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email, $logo);
            if($retorno){
    ...
    public function editarEmitente() {
        ...
        if ($this->form_validation->run() == false) {
            ...
            $retorno = $this->gestorjr_model->editEmitente($id, $nome, $cnpj, $ie, $logradouro, $numero, $bairro, $cidade, $uf,$telefone,$email);
            if($retorno){
    ...
    public function editarLogo(){
        ...
        $retorno = $this->gestorjr_model->editLogo($id, $logo);
        if($retorno){
